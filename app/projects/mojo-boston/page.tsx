    ...
    <div className="max-w-3xl lg:py-24">
      ...
      <section className="mb-12">
        ...
        <p className="text-slate-400 leading-relaxed">
          ...
          same data already living in Knokr Base. The question was whether an off-the-shelf CMS
          like PayloadCMS could serve as the foundation for a white-label festival site product,
          or whether the domain-specific requirements would outgrow it.
        </p>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-slate-400 leading-relaxed">
              The stock template&apos;s generic content blocks couldn&apos;t handle festival-specific
              layouts. I built 24 purpose-built blocks — a lineup word cloud with artist names sized
              by billing tier using Thingbat separator fonts, a day-tabbed schedule with stage
              grouping and 12h/24h time toggle, flip-card ticket tiers with front/back detail views,
              interactive Leaflet venue maps with Stadia dark tiles, sponsor grids, FAQ accordions
              with category headings, and more. Every block exposes full admin-configurable styling:
              colors, 4-way padding, max width, background images, rounded corners, shadows, font
              sizes and weights. This gives organizers real design control without touching code.
            </p>
          </div>
          <div>
            ...
            <p className="text-slate-400 leading-relaxed">
              ...
              KNOKR_FESTIVAL_ID environment variable connects the site to the correct festival record.
            </p>
          </div>
          <div>
            ...
            <p className="text-slate-400 leading-relaxed">
              ...
              endpoint to reconcile existing S3 bucket files with database records. Local storage
              is fully disabled — disableLocalStorage: true means no files on disk, no Sharp
              processing issues with SVGs, and all frontend components use the s3Url field for
              direct S3 access.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-slate-400 leading-relaxed">
              ...
              golden ratio (1.618:1) for artist card images, and a rule of no opacity on text.
              Every block supports the full color palette through admin select fields, so the
              organizer controls brand consistency from the CMS. A custom festival hero type
              supports background video (MP4/WebM/YouTube), 9-position content alignment, and
              per-line color, size, font, and weight controls.
            </p>
          </div>
        </div>
      </section>
